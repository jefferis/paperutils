\batchmode
\makeatletter
\def\input@path{{/GD/dev/R/pdfutils/inst/lyx//}}
\makeatother
...
\begin{figure*}[h]
\begin{centering}
\includegraphics{0_GD_dev_R_pdfutils_inst_lyx_fig1.pdf}\caption{\label{fig:wt}\textbf{S}ome Figure}
...
\begin{figure*}[h]
\begin{centering}
\includegraphics{23_GD_dev_R_pdfutils_inst_lyx_fig2.pdf}\caption{\label{fig:Or67d}Another figure}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[height=1\textheight]{24_GD_dev_R_pdfutils_inst_lyx_composite_fig.pdf}
\par\end{centering}
