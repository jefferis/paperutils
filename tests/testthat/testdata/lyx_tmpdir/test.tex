...
\begin{figure*}[h]
\begin{centering}
\includegraphics{36_GD_dev_R_paperutils_inst_lyx_fig1.pdf}\caption{\label{fig:wt}\textbf{S}ome Figure}
...
\begin{figure*}[h]
\begin{centering}
\includegraphics{37_GD_dev_R_paperutils_inst_lyx_fig2.pdf}\caption{\label{fig:Or67d}Another figure}
...
\appendix
\pagestyle{plain}\setcounter{page}{1}\setcounter{figure}{0}\renewcommand{\thefigure}{S\arabic{figure}}\setcounter{table}{0}\renewcommand{\thetable}{S\arabic{table}}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[height=0.75\textheight]{38_GD_dev_R_paperutils_inst_lyx_composite_fig.pdf}
\par\end{centering}
